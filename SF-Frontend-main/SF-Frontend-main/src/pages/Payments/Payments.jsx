        ...
        { key: 'collectedBy', label: 'Collected By', render: (r) => <span className="text-sm text-slate-600 dark:text-slate-400">{formatName(r.collectedBy)}</span> },
        {
            ...
            render: (r) => (
                <div className="flex items-center justify-end gap-1">
                    <button onClick={() => navigate(`/payments/${r.id}`, { state: { payment: r, autoPrint: false } })} className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 transition hover:bg-sky-50 hover:text-sky-600 dark:hover:bg-sky-900/30" title="View Receipt">
                        <FiEye size={16} />
                    </button>
                    <button onClick={() => navigate(`/payments/${r.id}`, { state: { payment: r, autoPrint: true } })} className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 transition hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-slate-800 dark:hover:text-slate-200" title="Print Receipt">
                        <FiPrinter size={16} />
                    </button>
                </div>
            )
    ...
    return (
        <div className="space-y-6 pb-12">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-xl font-bold text-slate-900 dark:text-white sm:text-2xl">Payments</h1>
            ...
            <div className="rounded-3xl border border-slate-200/90 bg-white p-6 shadow-soft dark:border-slate-700/90 dark:bg-slate-900">
                ...
                <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-end">
                    <div className="flex-1 max-w-md relative">
                        ...
                        <input
                            type="text"
                            placeholder="Search customer, loan or payment ID..."
                            value={searchTerm}
