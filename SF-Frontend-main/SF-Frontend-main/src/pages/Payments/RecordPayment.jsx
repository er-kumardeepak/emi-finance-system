    ...
    return (
        <div className="pb-8">
            ...
            <div className="mb-6 flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-xl font-bold text-slate-900 dark:text-white sm:text-2xl">Record Payment</h1>
                    <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        Collect EMI payment from a customer.
                    </p>
                </div>
            </div>
                ...
                <div className="flex flex-col xl:flex-row gap-6">
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="rounded-3xl border border-slate-200/90 bg-white p-6 shadow-soft dark:border-slate-700/90 dark:bg-slate-900">
                            <h2 className="mb-4 text-base font-semibold text-slate-900 dark:text-white">1. Select Customer</h2>
                            <div className="relative" ref={searchRef}>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-2xl border border-slate-200 bg-slate-50 pl-10 pr-10 py-3 text-sm text-slate-900 outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
                        ...
                        {selectedCustomer && (
                            <div className="rounded-3xl border border-slate-200/90 bg-white p-6 shadow-soft dark:border-slate-700/90 dark:bg-slate-900 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                <h2 className="mb-4 text-base font-semibold text-slate-900 dark:text-white">2. Select Loan</h2>
                                {isLoadingLoans ? (
                                    <div className="py-4"><Loader /></div>
                                ) : customerLoans.length === 0 ? (
                                    <div className="text-sm text-slate-500 py-2">This customer has no active loans.</div>
                                ) : (
                                        ...
                                        {customerLoans.map(loan => (
                                            ...
                                            >
                                                ...
                                                <div className="text-xs text-slate-500 dark:text-slate-400 space-y-1">
                                                    <p>Loan ID: {loan.id}</p>
                                                    <p className="text-sm font-semibold">Outstanding: {formatCurrency(loan.outstandingBalance)}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                        ...
                        {selectedLoan && (
                            <div className="rounded-3xl border border-slate-200/90 bg-white p-6 shadow-soft dark:border-slate-700/90 dark:bg-slate-900 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                <h2 className="mb-4 text-base font-semibold text-slate-900 dark:text-white">3. Select EMI</h2>
                                {isLoadingEmis ? (
                                    <div className="py-4"><Loader /></div>
                        ...
                        {selectedEmi && (
                            <div className="rounded-3xl border border-slate-200/90 bg-white p-6 shadow-soft dark:border-slate-700/90 dark:bg-slate-900 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                <h2 className="mb-4 text-base font-semibold text-slate-900 dark:text-white">4. Payment Details</h2>
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        <Input label="Payment Date *" id="paymentDate" type="date" value={formData.paymentDate} onChange={handleChange} />
                                    </div>
                                    <div>
                                        <Input label="Amount Paid *" id="amountPaid" value={formData.amountPaid} onChange={handleChange} placeholder="₹ 0" />
                ...
                <div className="mt-6 mx-auto max-w-7xl">
                    <div className="flex items-center justify-between gap-3 border-t border-slate-100 pt-4 dark:border-slate-800">
                        <button
                            type="button"
                            onClick={handleReset}
                            className="text-sm text-slate-400 underline-offset-2 transition hover:text-slate-600 hover:underline dark:text-slate-500 dark:hover:text-slate-300"
                        >
                            Reset form
                        </button>
