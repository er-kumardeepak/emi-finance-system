...
import { MdPerson, MdEmail, MdPhone, MdBadge, MdDateRange, MdShield, MdEdit } from 'react-icons/md';
...
const ProfilePage = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!userId) {
            setSaveError('Unable to update this profile because the user ID is missing.');
            return;
        }
