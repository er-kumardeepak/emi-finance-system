        ...
        <>
            ...
            >
                <div className="flex items-center justify-between gap-4 px-2 lg:hidden">
                    <div>
                        <span className="font-display inline-flex items-center gap-2 text-lg font-semibold text-slate-900 dark:text-slate-100">
                ...
                <div className="mt-6 hidden px-2 lg:block">
                    <div className="flex items-center gap-3">
                        ...
                        <p className="font-display text-lg font-semibold text-slate-900 dark:text-slate-100">{brand.name}</p>
                    </div>
                    <p className="mt-3 text-sm text-slate-500 dark:text-slate-400">{brand.tagline}</p>
                </div>
